...
export default function LoginPage() { return <AuthPage title="Welcome back" text="Sign in to your academy workspace."><AuthForm mode="login" /><p className="mt-6 text-center text-sm text-slate-600">New to DarsFlow? <Link href="/register" className="font-bold text-teal-700">Start a free trial</Link></p></AuthPage>; }
