...
export const subscriptionPlans = sqliteTable("subscription_plans", {
  id: text("id").primaryKey(), name: text("name").notNull().unique(), activeStudentLimit: integer("active_student_limit").notNull(), activeTeacherLimit: integer("active_teacher_limit").notNull(), priceMinor: integer("price_minor"), currency: text("currency"), active: boolean("active").notNull().default(true), ...timestamps,
});
